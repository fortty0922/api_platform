...
# 預設使用不安全的隨機字串，但強制建議生產環境必須從 .env 載入
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-key-for-dev-only-change-me')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

# 解析 ALLOWED_HOSTS (使用逗號分隔，例如: ALLOWED_HOSTS=127.0.0.1,localhost)
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'core.authentication.UIDAuthentication',
    ],
